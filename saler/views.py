...
def studentSessions(request):
    ...
    return render(request,"saler/student/student_sessions.html",context)
...
def studentProfile(request):
    ...
    try:
        ...
        return render(request, "saler/student/student_profile_form.html",)
...
def updateStudentProfile(request):
    ...
    if request.method == "POST":
        ...
        return saveStudentForm(request,userDetails=user_details)
       ...
       user_details=main_models.StudentDetails.objects.filter(user=user).first()
       if user_details:
           return render(request,"saler/student/student_profile_form.html",{"user_details":user_details}) 
       else:
...
def saveStudentForm(request,userDetails:main_models.StudentDetails):
    ...
    if userDetails:
        main_models.StudentDetails.objects.filter(user=user).update(
        contact_number=contact_number,
        subjects=subjects,
        grade_level=grade_level,
        preferred_tutoring_format=preferred_tutoring_format,
